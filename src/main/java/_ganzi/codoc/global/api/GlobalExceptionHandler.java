...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleBadRequestException(Exception exception) {
        return ResponseEntity
                .status(GlobalErrorCode.INVALID_INPUT.status())
                .body(ApiResponse.error(GlobalErrorCode.INVALID_INPUT.code(), GlobalErrorCode.INVALID_INPUT.message()));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleMethodNotAllowedException(Exception exception) {
        return ResponseEntity
                ...
                .body(ApiResponse.error(GlobalErrorCode.METHOD_NOT_ALLOWED.code(),
    ...
    public ResponseEntity<ApiResponse<Void>> handleException(Exception exception) {
        ...
        return ResponseEntity
                ...
                .body(ApiResponse.error(GlobalErrorCode.INTERNAL_SERVER_ERROR.code(),
